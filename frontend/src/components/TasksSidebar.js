  ...
  return(
    <div className="w-80 flex flex-col h-full" style={{background:'#fff',borderRight:`1.5px solid ${LB}`}}>
      ...
      <div className="p-4" style={{borderTop:`1.5px solid ${LB}`}}>
        <a href="/agents" className="flex items-center text-sm" style={{color:TM}}
          onMouseEnter={e=>{e.currentTarget.style.color=L;}} onMouseLeave={e=>{e.currentTarget.style.color=TM;}}>
