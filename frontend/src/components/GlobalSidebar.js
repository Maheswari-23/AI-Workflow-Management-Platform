...
const navLinks = [
  ...
  { href: '/marketplace', label: 'Marketplace', badge: 'New', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /> },
  ...
  { href: '/templates', label: 'Templates', badge: 'New', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /> },
  ...
  { href: '/cost', label: 'Cost Management', badge: 'New', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
    ...
    <div className="w-64 h-screen flex flex-col fixed left-0 top-0 overflow-y-auto z-50" style={{ background: '#fff', borderRight: `1.5px solid ${LB}` }}>
      ...
      <div className="p-6" style={{ borderBottom: `1px solid ${LB}` }}>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: `linear-gradient(135deg, ${L} 0%, #9333ea 100%)`, boxShadow: '0 4px 12px rgba(181,123,238,0.3)' }}>
            <svg className="w-6 h-6" style={{ color: '#fff' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <div>
            <span className="font-bold text-lg tracking-tight" style={{ color: TH }}>Orchestr</span>
            <p className="text-[10px] tracking-wide" style={{ color: TM }}>AI Workflow Platform</p>
          </div>
        </div>
      </div>
          ...
          {navLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                {link.label}
                {link.badge && (
                  <span className="ml-auto text-[10px] px-2 py-0.5 rounded-full font-bold" style={{ background: '#fef3c7', color: '#92400e' }}>
                    {link.badge}
                  </span>
                )}
              </Link>
